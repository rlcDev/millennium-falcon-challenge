...
import { IMPORTED_FILE_ISSUE, INTERNAL_ERROR, ODD_PROPERLY_COMPUTE } from "controllers/constants/controllers.contants";
...
export class MissionOddController {
  ...
  async getOdd(
    ...
    try {
      ...
      const OddResponse: OddResponse = { message: odd.toString(), statusCode: HttpStatus.OK, error: null };
